...
const Todo = () => {
    ...
    return (
      <div className="m-2 md:m-10 mt-24 p-2 md:p-10 bg-white rounded-3xl">
        ...
        <KanbanComponent id="kanban" keyField="Status" cssClass="kanban-header" dataSource={kanbanData} cardSettings={{ contentField: 'Summary', headerField: 'Id' }} dialogSettings={{ fields }}>
          <ColumnsDirective>
